...
export default function Range(props: { element: any, setInputValues: any, inputValues: any }) {
    ...
    return (
        ...
        >
            ...
            <input
                id={inputId}
                className={`form-range ${isValid ? '' : 'is-invalid'}`} // Apply Bootstrap validation class
                type="range"
                name={inputId}
                min={element.field_validations.min_value}
                max={element.field_validations.max_value}
                step={element.field_validations.step}
            ...
            <div className="invalid-feedback">
                ...
                Please select a valid date within the specified range.
            </div>
        </StyledDiv>
    );
}
